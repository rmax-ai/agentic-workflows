...
- Active target: restore domain parity with one instance-only pass in a trailing domain (`engineering`, `compliance`, `operations`, or `hr`), preferably in a different family than `human-agent-collaborative-work`.
