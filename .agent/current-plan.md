...
- Grounded coverage now spans two hundred fifty examples across all seven modeled domains; engineering, finance, compliance, hr, and support now stand at thirty-six while operations and research remain at thirty-five, confirming that Phase 7 can tolerate light asymmetry when it deepens structurally thinner slices.
